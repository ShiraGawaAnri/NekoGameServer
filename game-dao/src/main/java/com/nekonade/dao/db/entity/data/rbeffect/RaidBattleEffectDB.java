...
@Getter
@Setter
@Document("RaidBattleEffectDB")
public class RaidBattleEffectDB implements Serializable {
    ...
    @DBRef
    private RaidBattleEffectGroupDB effectGroup;//表示同一组buff/debuff时,方便设计累计上限 0:common
